...
L'objet de cet exercice est la création des classes du domaine fr.just_abdel.ourbusinessproject.Project et Enterprise. 
La description des relations entre ces entités ne fait pas l'objet de cet exercice, 
elle sera étudiée dans la 2ème partie.

## 1. Classe fr.just_abdel.ourbusinessproject.Project

1. Depuis votre IDE, créez la classe du domaine «ourbusinessproject.fr.just_abdel.ourbusinessproject.Project » (il s'agit de créer une classe Java « standard »).

2. Créez la classe de test associée à la classe du domaine «fr.just_abdel.ourbusinessproject.Project» en spécifiant :
...
4. Modifiez la classe fr.just_abdel.ourbusinessproject.Project de telle sorte que les tests passent. Vous pouvez vous aider de l'aide en ligne suivante : 
http://docs.oracle.com/javaee/6/tutorial/doc/gircz.html

> fix #1.1 classe fr.just_abdel.ourbusinessproject.Project 

## 2. Classe Enterprise

Créez la classe du domaine «ourbusinessproject.Enterprise» en suivant la même démarche que pour la classe fr.just_abdel.ourbusinessproject.Project. Le contenu de la classe EnterpriseTest se trouve ici :  
...
1. Complétez les classes fr.just_abdel.ourbusinessproject.Project et Enterprise de telle sorte que les objets instances de ces 
...
> fix #1.3 Mapping fr.just_abdel.ourbusinessproject.Project et Enterprise
